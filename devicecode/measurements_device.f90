SUBROUTINE measurements_device(xmat,alpha,nbc,nbmn,temperature,flux,&
  ...
  integer nbc,nbmn,ntrial,iteration,itraj,nacceptance
...
END SUBROUTINE measurements_device
